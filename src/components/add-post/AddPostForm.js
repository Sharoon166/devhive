...
import { Input, Button, Textarea, Chip } from "@nextui-org/react";
import { LuCamera, LuHeading, LuText, LuUploadCloud, LuHash, LuTrash2 } from "react-icons/lu";
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end">
                <Button
                    ...
                    type="submit"
                    startContent={<LuUploadCloud className="text-xl" />}
                >
                    Publish Post
                </Button>
            </div>
